...
@section('title', 'Thêm danh mục Tài liệu hệ thống ISO')

@section('content')
<div class="admin-page">
    <div class="admin-page__header">
        <div class="admin-page__title-section">
            <h1 class="admin-page__title">Thêm danh mục Tài liệu hệ thống ISO</h1>
            <p class="admin-page__subtitle">Tạo danh mục mới cho Tài liệu hệ thống ISO</p>
        </div>
    ...
    <div class="admin-card">
        <form action="{{ route('admin.iso-system-categories.store') }}" method="POST" class="admin-form">
            @csrf
            ...
            <div class="admin-form__row">
                <div class="admin-form__group admin-form__group--full">
                    ...
                    <textarea id="description" name="description" rows="3" class="admin-form__input @error('description') admin-form__input--error @enderror" placeholder="Mô tả chi tiết về danh mục (tùy chọn)">{{ old('description') }}</textarea>
                    @error('description')
                        <span class="admin-form__error">{{ $message }}</span>
                    @enderror
