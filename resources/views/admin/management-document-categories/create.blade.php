...
@section('title', 'Thêm danh mục Văn bản quản lý')

@section('content')
<div class="admin-page">
    <div class="admin-page__header">
        <div class="admin-page__title-section">
            <h1 class="admin-page__title">Thêm danh mục Văn bản quản lý</h1>
            <p class="admin-page__subtitle">Tạo danh mục mới cho Văn bản quản lý</p>
        </div>
    ...
    <div class="admin-card">
        <form action="{{ route('admin.management-document-categories.store') }}" method="POST" class="admin-form">
            @csrf
