...
<div class="admin-page">
    ...
    <div class="admin-page__header">
        <div class="admin-page__title-section">
            <h1 class="admin-page__title">Thêm tài liệu nội bộ</h1>
            <p class="admin-page__subtitle">Tạo và quản lý tài liệu nội bộ mới</p>
        </div>
    ...
    <div class="admin-document-form">
        <div class="admin-card">
            <form method="POST" action="{{ route('admin.internal-documents.store') }}" class="admin-form" enctype="multipart/form-data">
                @csrf
                ...
                <div class="admin-form__row admin-form__row--split">
                    ...
                    <div class="admin-form__group">
                        ...
                        @if(auth()->user()->role == 2 && auth()->user()->department_id)
                            <!-- Role 2 can only create documents for their own department -->
                ...
                <div class="admin-form__actions">
                    <a href="{{ route('admin.internal-documents.index') }}" class="admin-btn admin-btn--secondary">Hủy</a>
