...
@section('title', 'Chỉnh sửa văn bản - Ban chỉ đạo ISO')
                        ...
                        @else
                            ...
                            <select name="category_id" id="category_id"
                                ...
                                @foreach($categories as $categoryOption)
                                    <option value="{{ $categoryOption['id'] }}" {{ old('category_id', $isoDirectiveDocument->category_id) == $categoryOption['id'] ? 'selected' : '' }}>
                                        {{ $categoryOption['name'] }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="admin-form__row">
                    <div class="admin-form__group">
                        ...
                        <textarea name="summary" rows="3" 
                                  ...
                                  placeholder="Nhập trích yếu tài liệu">{{ old('summary', $isoDirectiveDocument->summary) }}</textarea>
                        @error('summary')
                        <div class="admin-form__error">{{ $message }}</div>
                        @enderror
                    </div>
