...
@section('title', 'Thêm quy trình mới')
...
<div class="admin-page">
    <div class="admin-breadcrumb">
        ...
        <span class="admin-breadcrumb__item admin-breadcrumb__item--current">Thêm quy trình mới</span>
    </div>
    
    <div class="admin-page__header">
        <div class="admin-page__title-section">
            <h1 class="admin-page__title">Thêm quy trình mới</h1>
            <p class="admin-page__subtitle">Tạo và quản lý quy trình mới</p>
        </div>
    ...
    <div class="admin-document-form">
        <div class="admin-card">
            <form method="POST" action="{{ route('admin.new-processes.store') }}" class="admin-form">
                @csrf
