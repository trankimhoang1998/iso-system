...
<div class="admin-page">
    <div class="admin-breadcrumb">
        ...
        <span class="admin-breadcrumb__item admin-breadcrumb__item--current">Thêm thông báo mới</span>
    </div>
    
    <div class="admin-page__header">
        <div class="admin-page__title-section">
            <h1 class="admin-page__title">Thêm thông báo mới</h1>
            <p class="admin-page__subtitle">Tạo và quản lý thông báo mới</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.notifications.store') }}" class="admin-form">
                ...
                <div class="admin-form__row admin-form__row--split">
                    ...
                    <div class="admin-form__group">
                        ...
                        <input type="url" name="document_link" value="{{ old('document_link') }}" 
