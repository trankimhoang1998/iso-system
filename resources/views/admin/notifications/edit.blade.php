...
<div class="admin-page">
    <div class="admin-breadcrumb">
        <a href="{{ route('admin.notifications.index') }}" class="admin-breadcrumb__item">Quản lý thông báo</a>
        <svg class="admin-breadcrumb__separator" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
        </svg>
        <span class="admin-breadcrumb__item admin-breadcrumb__item--current">Sửa thông báo</span>
    </div>
    
    <div class="admin-page__header">
        <div class="admin-page__title-section">
            <h1 class="admin-page__title">Sửa thông báo</h1>
            <p class="admin-page__subtitle">Cập nhật thông tin thông báo</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.notifications.update', $notification) }}" class="admin-form">
                ...
                <div class="admin-form__row">
                    <div class="admin-form__group">
                        <label class="admin-form__label admin-form__label--required">Tiêu đề thông báo</label>
                ...
                <div class="admin-form__row admin-form__row--split">
                    <div class="admin-form__group">
                        ...
                        <input type="date" name="issue_date" value="{{ old('issue_date', $notification->issue_date->format('Y-m-d')) }}" 
                    ...
                    <div class="admin-form__group">
                        ...
                        <input type="url" name="document_link" value="{{ old('document_link', $notification->document_link) }}" 
                ...
                <div class="admin-form__actions">
                    <a href="{{ route('admin.notifications.index') }}" class="admin-btn admin-btn--secondary">Hủy</a>
