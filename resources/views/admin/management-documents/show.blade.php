...
<div class="admin-page">
    ...
    <div class="admin-page__header">
        ...
        <div class="admin-page__actions">
            @if($managementDocument->file_path)
            <a href="{{ route('admin.management-documents.download', $managementDocument) }}"
    ...
    <div class="admin-document-viewer">
        <div class="admin-document-header">
            <div class="admin-document-meta">
                ...
                @if($managementDocument->department)
                <div class="admin-document-meta__item">
                    <span class="admin-document-meta__label">Phòng ban:</span>
                    <span class="admin-document-meta__value">{{ $managementDocument->department->name }}</span>
                </div>
                @endif
                @if($managementDocument->file_size)
                <div class="admin-document-meta__item">
                    <span class="admin-document-meta__label">Kích thước:</span>
                    <span class="admin-document-meta__value">{{ $managementDocument->getFormattedFileSize() }}</span>
                </div>
                @endif
                <div class="admin-document-meta__item">
            ...
            <div class="admin-document-file__info">
                <div class="admin-file-item">
                    ...
                    <div class="admin-file-item__details">
                        <div class="admin-file-item__name">{{ $managementDocument->file_name }}</div>
                        @if($managementDocument->file_size)
                        <div class="admin-file-item__size">{{ $managementDocument->getFormattedFileSize() }}</div>
                        @endif
                        @if($managementDocument->file_type)
                        <div class="admin-file-item__type">{{ strtoupper($managementDocument->file_type) }}</div>
                        @endif
                    </div>
                    <a href="{{ route('admin.management-documents.download', $managementDocument) }}"
