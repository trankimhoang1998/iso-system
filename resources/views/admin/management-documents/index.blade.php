...
<div class="admin-page">
    <div class="admin-page__header">
        <div>
            <h1 class="admin-page__title">Tài liệu quản lý</h1>
                ...
                <tr class="admin-table__row">
                    ...
                    <td class="admin-table__cell">
                        <div class="admin-table__actions">
                            ...
                            <a href="{{ route('admin.management-documents.download', $document) }}"
                ...
                <tr>
                    <td colspan="8" class="admin-table__empty">
                        <div class="admin-empty-state">
                            ...
                            <p class="admin-empty-state__description">Tạo tài liệu quản lý đầu tiên</p>
