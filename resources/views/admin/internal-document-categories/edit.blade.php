        ...
        <form action="{{ route('admin.internal-document-categories.update', $internalDocumentCategory) }}" method="POST" class="admin-form">
            ...
            <div class="admin-form__row">
                <div class="admin-form__group admin-form__group--full">
                    ...
                    <input type="text" id="name" name="name" class="admin-form__input @error('name') admin-form__input--error @enderror" value="{{ old('name', $internalDocumentCategory->name) }}" required>
                    @error('name')
