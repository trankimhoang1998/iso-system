...
@section('title', 'Thêm danh mục Tài liệu nội bộ')

@section('content')
<div class="admin-page">
    <div class="admin-page__header">
        <div class="admin-page__title-section">
            <h1 class="admin-page__title">Thêm danh mục Tài liệu nội bộ</h1>
            <p class="admin-page__subtitle">Tạo danh mục mới cho Tài liệu nội bộ</p>
        </div>
    ...
    <div class="admin-card">
        <form action="{{ route('admin.internal-document-categories.store') }}" method="POST" class="admin-form">
            @csrf
