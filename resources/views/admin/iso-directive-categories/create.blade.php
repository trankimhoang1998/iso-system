...
@section('title', 'Thêm danh mục Ban chỉ đạo ISO')

@section('content')
<div class="admin-page">
    <div class="admin-page__header">
        <div class="admin-page__title-section">
            <h1 class="admin-page__title">Thêm danh mục Ban chỉ đạo ISO</h1>
            <p class="admin-page__subtitle">Tạo danh mục mới cho Ban chỉ đạo ISO</p>
        </div>
    ...
    <div class="admin-card">
        <form action="{{ route('admin.iso-directive-categories.store') }}" method="POST" class="admin-form">
            @csrf
