    ...
    <div class="admin-page__header">
        <div>
            <p class="admin-page__subtitle">
                @php
                    $subtitle = 'Quản lý các tài liệu của Hệ thống quản lý chất lượng theo tiêu chuẩn quốc gia TCVN ISO 9001:2015, bao gồm: Sổ tay chất lượng, các Quy trình hệ thống và các Quy trình tác nghiệp.';
    ...
    if (tableBody) {
        new Sortable(tableBody, {
            ...
            onEnd: function(evt) {
                ...
                fetch('{{ route("admin.iso-system-documents.reorder") }}', {
                    method: 'POST',
                    headers: {
