            ...
            <form method="POST" action="{{ route('admin.iso-system-documents.update', $isoSystemDocument) }}" class="admin-form" enctype="multipart/form-data">
                ...
                <div class="admin-form__row admin-form__row--split">
                    ...
                    <div class="admin-form__group">
                        ...
                        <input type="text" name="time_period" value="{{ old('time_period', $isoSystemDocument->time_period) }}" 
                ...
                <div class="admin-form__row admin-form__row--split">
                    <div class="admin-form__group">
                        ...
                        <input type="text" name="document_number" value="{{ old('document_number', $isoSystemDocument->document_number) }}" 
                    ...
                    <div class="admin-form__group">
                        ...
                        <input type="text" name="issuing_agency" value="{{ old('issuing_agency', $isoSystemDocument->issuing_agency) }}" 
                ...
                <div class="admin-form__row">
                    <div class="admin-form__group">
                        ...
                        <textarea name="summary" rows="3" 
                                  ...
                                  placeholder="Nhập trích yếu tài liệu (tùy chọn)">{{ old('summary', $isoSystemDocument->summary) }}</textarea>
                        @error('summary')
                        <div class="admin-form__error">{{ $message }}</div>
                        @enderror
                    </div>
