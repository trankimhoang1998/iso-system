...
class IsoDirectiveCategory extends Model
{
    use HasFactory;
    ...
    {
        return $this->belongsTo(IsoDirectiveCategory::class, 'parent_id');
    }

    public function children(): HasMany
    {
        return $this->hasMany(IsoDirectiveCategory::class, 'parent_id');
    }

    public function documents(): HasMany
    {
        return $this->hasMany(IsoDirectiveDocument::class, 'category_id');
    }
