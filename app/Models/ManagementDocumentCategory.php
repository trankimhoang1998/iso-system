...
class ManagementDocumentCategory extends Model
{
    use HasFactory;
    ...
    {
        return $this->belongsTo(ManagementDocumentCategory::class, 'parent_id');
    }

    public function children(): HasMany
    {
        return $this->hasMany(ManagementDocumentCategory::class, 'parent_id');
    }

    public function documents(): HasMany
    {
        return $this->hasMany(ManagementDocument::class, 'category_id');
    }
